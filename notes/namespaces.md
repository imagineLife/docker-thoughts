...
- RUNS bash inside the dir after chrooting into it
...
root         9  0.0  0.1  34400  2844 ?        R+   11:18   0:00 ps aux
...
root      7451  0.0  0.1  34404  2896 pts/1    R+   11:22   0:00 ps aux

notice more processes than the child 'knows' about!


NOTE the host can deal with ALL child processes.
Child CANNOT see outside itlsef after using this namespace unsharing.